...
extern "C" void link_entry(void* link_shm) {
    ...
    SDL_Window* win = SDL_CreateWindow("SDL in Chain-Lang", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, 0);
    ...
    while(running) {
        while(SDL_PollEvent(&e)) {
            ...
            // Example: Modify Chain-Lang variables directly from C++ input!
        ...
        // 3. THE MAGIC: Draw using Chain-Lang's Shared Memory Macros!
